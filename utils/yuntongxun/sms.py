...
_accountSid = '2c94811c8a27cf2d018a3a26e36e04e6'

# 说明：主账号Token，登陆云通讯网站后，可在控制台-应用中看到开发者主账号AUTH TOKEN
_accountToken = '9aa66f7ffde14e51810ce17ab6d7d6c1'

# 请使用管理控制台首页的APPID或自己创建应用的APPID
_appId = '2c94811c8a27cf2d018a3a26e4b004ed'
...
if __name__ == '__main__':
    ...
    result = None
    while True:
        result = ccp.send_template_sms('13984420583', ['6666', 5], "1")
        if result == 0:
            print('短信验证码发送成功！')
            break
